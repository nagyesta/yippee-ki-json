...
class DecimalDivideFunctionTest {
    ...
    void testApplyShouldDivideNumbersProperly(final String a, final String b, final String scale, final String expected) {
        //given
        DecimalDivideFunction underTest = new DecimalDivideFunction(b, scale);
