...
class ParameterContextTest {
    ...
    private static Stream<Arguments> validValueProvider() {
        return Stream.<Arguments>builder()
                ...
                .add(Arguments.of(ParameterContext.UseCase.VALUE, PARAM_JAKARTA_NULLABLE, PARAM_JAKARTA_NULLABLE, false, true))
                ...
                .add(Arguments.of(ParameterContext.UseCase.MAP, PARAM_JAKARTA_NULLABLE, PARAM_JAKARTA_NULLABLE, false, true))
                ...
                .add(Arguments.of(ParameterContext.UseCase.EMBEDDED, PARAM_JAKARTA_NULLABLE, PARAM_JAKARTA_NULLABLE, false, true))
