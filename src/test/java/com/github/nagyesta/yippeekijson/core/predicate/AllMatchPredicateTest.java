...
class AllMatchPredicateTest {

    static final Predicate<Object> NON_NULL = Objects::nonNull;
    ...
    private static final Predicate<Object>[] NON_NULL_STRING = new Predicate[]{NON_NULL, STRING};
    @SuppressWarnings("unchecked")
    private static final Predicate<Object>[] NON_NULL_INTEGER = new Predicate[]{NON_NULL, INTEGER};

    private static Stream<Arguments> validProvider() {
        return Stream.<Arguments>builder()
                .add(Arguments.of(false, VALUE, NON_NULL_INTEGER))
                .add(Arguments.of(false, null, NON_NULL_INTEGER))
                .add(Arguments.of(false, null, NON_NULL_STRING))
                .add(Arguments.of(true, VALUE, NON_NULL_STRING))
                .build();
    }
    ...
    void testTestShouldEvaluateChildren(final boolean expected, final Object value, final Predicate<Object>[] predicates) {
        ...
        AllMatchPredicate underTest = new AllMatchPredicate(dummyParams, functionRegistry);
